...
# Label for data: 1 - botnet, 0 - people
people_data['Label'] = 0
...
# Use CountVectorizer to translate 'Domain' colum from text to feature vector
...
with PdfPages('../Result/DecisionTree_ROC_Curve.pdf') as pdf:
    plt.figure()
...
with PdfPages('../Result/DecisionTree_Confusion_Matrix.pdf') as pdf:
    plt.figure()
...
with open('../Result/DecisionTree.txt', 'w') as file:
